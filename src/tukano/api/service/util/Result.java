package tukano.api.service.util;
 ...
 * 
 */
class OkResult<T> implements tukano.api.service.util.Result<T> {
...
class ErrorResult<T> implements tukano.api.service.util.Result<T> {
